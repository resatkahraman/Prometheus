...
import type { ApprovalReview, CoreStatus, DesktopBootstrap, DesktopCommandResponse, MemoryPage, Mission, MissionEvents, MissionHistory, ReceiptPage, RuntimeStatus } from '../types/desktop';
