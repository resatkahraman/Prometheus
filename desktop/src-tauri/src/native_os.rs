...
#[derive(Serialize)]
pub struct NativeEnvironmentInfo { pub os_family: &'static str, pub architecture: &'static str, pub application_version: String, pub runtime_platform: &'static str }
...
pub fn environment(app: &AppHandle) -> NativeEnvironmentInfo { NativeEnvironmentInfo { os_family: std::env::consts::FAMILY, architecture: std::env::consts::ARCH, application_version: app.package_info().version.to_string(), runtime_platform: std::env::consts::OS } }
